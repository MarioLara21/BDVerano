 ...
 * @author dnlal
 */
public class SedeQuery extends javax.swing.JFrame {

    /**
     * Creates new form SedeQuery
     */
    public SedeQuery() {
        initComponents();
    }
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        SedeFrame sedeFrame= new SedeFrame();
        sedeFrame.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SedeQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
