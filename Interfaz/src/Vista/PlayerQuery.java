 ...
 * @author dnlal
 */
public class PlayerQuery extends javax.swing.JFrame {

    /**
     * Creates new form PlayerQuery
     */
    public PlayerQuery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAddPlayer, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 70, 90, 30));
    ...
    private void btnAddPlayerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPlayerActionPerformed
        AddPlayer addPlayerWin= new AddPlayer();
        addPlayerWin.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlayerQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlayerQuery().setVisible(true);
            }
        });
    }
