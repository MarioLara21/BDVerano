 ...
 * @author dnlal
 */
public class TeamQuery extends javax.swing.JFrame {

    /**
     * Creates new form TeamQuery
     */
    public TeamQuery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAddTeam, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 70, 90, 30));
    ...
    private void btnAddTeamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddTeamActionPerformed
        AddTeam addTeamWin= new AddTeam();
        addTeamWin.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeamQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
