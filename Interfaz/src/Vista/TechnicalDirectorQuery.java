 ...
 * @author dnlal
 */
public class TechnicalDirectorQuery extends javax.swing.JFrame {

    /**
     * Creates new form TechnicalDirectorQuery
     */
    public TechnicalDirectorQuery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        LabelTitulo.setText("Directores Técnicos");
        jPanel1.add(LabelTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 400, 40));

        btnAddTD.setText("Agregar");
        btnAddTD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddTDActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddTD, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 70, 90, 30));
    ...
    private void btnAddTDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddTDActionPerformed
        AddTD addTDWin= new AddTD();
        addTDWin.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TechnicalDirectorQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TechnicalDirectorQuery().setVisible(true);
            }
        });
    }
