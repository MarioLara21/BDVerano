 ...
 * @author dnlal
 */
public class EventQuery extends javax.swing.JFrame {

    /**
     * Creates new form EventQuery
     */
    public EventQuery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(LabelTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, 190, 40));
        ...
        jPanel1.add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 70, 90, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventQuery().setVisible(true);
            }
        });
    }
